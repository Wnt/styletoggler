package org.vaadin.styletoggler.it;
...
import org.vaadin.styletoggler.BasicStyleTogglerUsageUI;
...
public class BasicMyComponentUsageIT extends AbstractWebDriverCase {
	...
	public void testJavaScriptComponentWithBrowser() throws InterruptedException {
		...
		driver.navigate().to(BASEURL + BasicStyleTogglerUsageUI.class.getName());
